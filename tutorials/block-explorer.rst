...
You can find the finished application code `here <https://github.com/eth-events/readthedocs/tree/master/example-apps/simple-block-explorer>`__.
...
the
`documentation <https://github.com/eth-events/readthedocs/tree/master/>`__.
...
code
`here <https://github.com/eth-events/readthedocs/tree/master/example-apps/simple-block-explorer>`__.
